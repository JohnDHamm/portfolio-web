import { NOG_ASSETS_URL } from '../index';
const DESIGN_URL = `${NOG_ASSETS_URL}/nog_design_slideshow_`;
const PROTOTYPE_URL = `${NOG_ASSETS_URL}/nog_prototype2_slideshow_`;

export const NogDesignImages: any[] = [
  `${DESIGN_URL}01.png`,
  `${DESIGN_URL}02.png`,
  `${DESIGN_URL}03.png`,
  `${DESIGN_URL}04.png`,
