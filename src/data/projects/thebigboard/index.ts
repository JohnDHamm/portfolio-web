import { BIGBOARD_ASSETS_URL } from '../index';
const DESKTOP_URL = `${BIGBOARD_ASSETS_URL}/bigBoard_desktop_slideshow_`;

export const BigBoardDesktopScreenshots: any[] = [
  `${DESKTOP_URL}01.png`,
  `${DESKTOP_URL}02.png`,
  `${DESKTOP_URL}03.png`,
  `${DESKTOP_URL}04.png`,
...
export const BigBoardMobileScreenshots: any[] = [
  `${MOBILE_URL}01.png`,
  `${MOBILE_URL}02.png`,
  `${MOBILE_URL}03.png`,
  `${MOBILE_URL}04.png`,
