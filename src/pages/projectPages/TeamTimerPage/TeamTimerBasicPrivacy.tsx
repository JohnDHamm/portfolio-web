...
export const TeamTimerBasicPrivacy: React.FC = () => {
  return (
    <PrivacyPageContainer>
      <h1>Privacy Policy</h1>
      <p>
        John Hamm built the Team Timer Basic app as a Free app. This SERVICE is
        provided by John Hamm at no cost and is intended for use as is.
      </p>
      <p>
