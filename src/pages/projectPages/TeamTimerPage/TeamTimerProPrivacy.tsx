...
export const TeamTimerProPrivacy: React.FC = () => {
  return (
    <PrivacyPageContainer>
      <h1>Privacy Policy</h1>
      <p>
        John Hamm built the Team Timer Pro app as a Commercial app. This SERVICE
        is provided by John Hamm at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Team Timer Basic unless
