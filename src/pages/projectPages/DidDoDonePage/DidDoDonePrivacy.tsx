...
export const DidDoDonePrivacy: React.FC = () => {
  return (
    <PrivacyPageContainer>
      <h1>Privacy Policy</h1>
      <p>
        John Hamm built the Did? Do! Done. app as a Commercial app. This SERVICE
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Did? Do! Done. unless
